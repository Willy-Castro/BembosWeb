            ...
            <div class="main">
                <div class="form-container">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="descripcion" placeholder="Descripción del proveedor">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="contacto" placeholder="Persona responsable">
                    </div>
                    ...
                    <div class="form-group" style="align-items:flex-start;">
                        <label>Insumos:</label>
                        <div class="checklist">
                            <label><input type="checkbox"> Carne de res</label>
                            <label><input type="checkbox"> Pollo</label>
                            <label><input type="checkbox"> Tocino</label>
